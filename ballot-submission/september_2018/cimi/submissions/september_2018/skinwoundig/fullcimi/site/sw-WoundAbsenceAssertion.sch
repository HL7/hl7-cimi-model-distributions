...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/sw/StructureDefinition/cimi-element-Category-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/sw/StructureDefinition/cimi-element-Category-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/sw/StructureDefinition/sw-WoundAnatomicalLocation-extension']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/us/sw/StructureDefinition/sw-WoundAnatomicalLocation-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/sw/StructureDefinition/sw-WoundAnatomicalLocation-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/sw/StructureDefinition/sw-WoundAnatomicalLocation-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
